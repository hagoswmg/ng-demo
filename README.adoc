...
You should see a screen like the one below at http://localhost:4400.
...
If you still have `ng serve` running, your browser should refresh automatically. If not, navigate to http://localhost:4400. You will likely see a blank screen. Open your JavaScript console and you'll see the problem.
